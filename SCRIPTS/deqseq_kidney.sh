...
write.csv(
  final,
  "/group/sbms006/rrubimsilvadocouto/NovaSeq_Data/genecount_all/kidney_all/Kidney_DIFFERENTIAL.csv",
  row.names = FALSE
)
...
write.csv(
  regulation,
  "/group/sbms006/rrubimsilvadocouto/NovaSeq_Data/genecount_all/kidney_all/Kidney_REGULATION.csv",
  row.names = FALSE
)
...
write.csv(
  venn_df,
  "/group/sbms006/rrubimsilvadocouto/NovaSeq_Data/genecount_all/kidney_all/Kidney_VENN.csv",
  row.names = FALSE
)
...
## Criar arquivo PNG
png(
  "/group/sbms006/rrubimsilvadocouto/NovaSeq_Data/genecount_all/kidney_all/Kidney_VENN_plot.png",
  width = 6000,
  height = 4000,
  res = 300
)
